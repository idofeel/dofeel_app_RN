...
const _processor = (...args) => args.map((item) => typeof item === 'function' ? item() : item);
...
export function ifIPhoneX(iphoneX, ios = {}, android = {}) {
...
export function StatusBarHeight(safe) {
    return Platform.select({
...
export const getSafeSize = (width, height) => {
